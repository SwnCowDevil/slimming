...
from app.analytics.schemas import AnalyticsSummary, PregnancyAnalyticsSummary
...
@router.get("/summary", response_model=AnalyticsSummary | PregnancyAnalyticsSummary)
def summary(
